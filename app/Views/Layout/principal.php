...
<html>
    <head> 
        ...
        <!--Espaço reservado para rendereizar os estilos de cada view que estender esse layout -->
    ...
    <body>
            ...
            <div class="page-content">
                ...
                <section class="no-padding-top no-padding-bottom">
                    ...
                    <div class="container-fluid">
                        ...
                        <!--Espaço reservado para rendereizar o conteudo de cada view que estender esse layout -->
        ...
        <!--Espaço reservado para rendereizar os scripts de cada view que estender esse layout -->
